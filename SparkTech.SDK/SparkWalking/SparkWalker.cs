    ...
    public class SparkWalker : Executable
    {
        ...
        private TargetData GetAttackableObject()
        {
            ...
            return new TargetData(
                    ...
                    orderby ward descending, obj.Health, this.Unit.DistanceSquared(obj)
                    select obj);
        }
        ...
        private TargetData GetJungleMinion()
        {
            ...
            return new TargetData(
                ...
                let type = minion.GetJungleType()
                orderby type == JungleType.Small == smallfirst descending, type descending, minion.Health, this.Unit.DistanceSquared(minion)
                select minion);
        }
